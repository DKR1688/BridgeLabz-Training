...
public class LibraryApp {
	public static void main(String[] args) {
		...
		//factory
		User student =UserFactory.createUser("student", "Deepak");
		User faculty =UserFactory.createUser("faculty", "Abhay");
		User guest =UserFactory.createUser("guest", "Ganni");
		...
		//builder
		Book book1 = new Book.BookBuilder("Design Patterns").author("GoF").edition("2nd").genre("Software Engineering").build();
